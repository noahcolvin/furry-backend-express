...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  const friendResult = await db
    .insertInto('friend')
    .values([
      { id: 1, name: 'Alice', image: storageUrl + '/furry-public/pets/pet1.jpg' },
      { id: 2, name: 'Bob', image: storageUrl + '/furry-public/pets/pet2.jpg' },
      { id: 3, name: 'Charlie', image: storageUrl + '/furry-public/pets/pet3.jpg' },
      { id: 4, name: 'David', image: storageUrl + '/furry-public/pets/pet4.jpg' },
      { id: 5, name: 'Eve', image: storageUrl + '/furry-public/pets/pet5.jpg' },
      { id: 6, name: 'Frank', image: storageUrl + '/furry-public/pets/pet6.jpg' },
      { id: 7, name: 'Grace', image: storageUrl + '/furry-public/pets/pet7.jpg' },
      { id: 8, name: 'Hank', image: storageUrl + '/furry-public/pets/pet8.jpg' },
    ])
    .execute();

  console.log('Friend insert', friendResult);
  ...
  console.log('Item insert', itemResult);
}
